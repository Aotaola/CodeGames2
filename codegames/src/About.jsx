        ...
        <form id="msform">
          <fieldset>
            ...
            <p style={{ display: "justify" }}>
              ...
              you have to move on to the next question! </p>
              <br></br>
              <p>Now that you've entered
              your name, your score will be displayed when the game is over, and
              you can compare your score with anyone that has played as well.
              Happy coding!
            </p>
          </fieldset>
        </form>
